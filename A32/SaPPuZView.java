...
public class SaPPuZView extends JFrame{
	...
	JMenuItem checkServerConnection = new JMenuItem();
	JMenuItem sendGame = new JMenuItem();
	JMenuItem recieveGame = new JMenuItem();
...
//	timer.
	...
	SaPPuZView( ) {
		...
		JButton[][] gridButton;
			...
			MenuBar.add(menu);
			MenuBar.add(online);
			checkServerConnection = new JMenuItem(" Check Server Connection");
			 sendGame = new JMenuItem("Send Game Config");
			JMenuItem recieveGame = new JMenuItem(" Join Game");
			online.add(checkServerConnection);
			online.add(sendGame);
			online.add(recieveGame);
	       // menubar.add(menu);
		    MenuBar.add(help);
		    MenuBar.add(about);
	 ...
	 void addListener(ActionListener e) {
		// System.out.println(gridButton[1][1]);
			...
			checkServerConnection.addActionListener(e);
	}
